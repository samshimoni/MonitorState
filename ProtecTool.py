...
def Close():
    ...
    os.rename("MonitorState", "MonitorState.{645ff040-5081-101b-9f08-00aa002f954e}")
...
def create_Windows():
    ...
    if not os.path.exists("MonitorState") and not os.path.exists("MonitorState.{645ff040-5081-101b-9f08-00aa002f954e}"):
        os.mkdir("MonitorState")
        with open("MonitorState/Status_Log.txt", 'w'): pass
        with open("MonitorState/processList.csv", 'wb'): pass
        Close()
